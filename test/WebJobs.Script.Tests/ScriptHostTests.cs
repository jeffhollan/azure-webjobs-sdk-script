...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    public class ScriptHostTests : IClassFixture<ScriptHostTests.TestFixture>
    {
        ...
        public void ApplyHostHealthMonitorConfig_AppliesExpectedSettings()
        {
            ...
            Assert.Equal(TimeSpan.FromMinutes(5), scriptConfig.HostHealthMonitor.HealthCheckWindow);
            Assert.Equal(10, scriptConfig.HostHealthMonitor.HealthCheckThreshold);
